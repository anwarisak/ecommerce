...
const Hero = () => {
  return (
    <section className="w-full max-w-[1240px] mx-auto items-center">
      <div className="md:flex items-center justify-center bg-white-100 p-8 ">
        ...
        <div className="bg-white mx-4">
          <img className="h-120 w-600 object-cover" src={heroimage} alt="" />
        </div>
        {/* lists */}
        <div className="">
          ...
          <div className="flex flex-col text-center justify-center items-center w-full h-25 md:w-50 md:h-28 rounded-lg shadow-lg">
            <ChessQueen />
            <h5 className="text-lg mx-4 my-2 font-light uppercase">LifeStyle</h5>
